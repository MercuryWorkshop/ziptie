...
public final class ClipboardManager {
    ...
    public boolean setImage(String uri) {
        String mimetype = uri.substring(uri.indexOf(":") + 1, uri.indexOf(";"));
        ...
        try {
            ...
            // File imageFile = new File("/sdcard/", "clipboard_image.png");
            // FileOutputStream outputStream = new FileOutputStream(imageFile);
            // bitmap.compress(Bitmap.CompressFormat.PNG, 100, outputStream);
            // outputStream.close();
            // // ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
            // // bitmap.compress(Bitmap.CompressFormat.PNG, 100, outputStream);
            // // Ln.i("bitmap size: " + outputStream.size());
            // Uri nuri = FileProvider.getUriForFile(
            //     FakeContext.get(),
            //     "com.discord.provider",
            //     new File("/sdcard/clipboard_image.png")
            // );
            // Ln.i("Setting clipboard image to " + nuri.toString());

            // // Ln.i("Setting clipboard image to " + imageFile.getAbsolutePath());
            // // Ln.i("uri: " + Uri.fromFile(imageFile).toString());
            // Method method = getSetPrimaryClipMethod();
        ...
        // }
            ...
            Ln.e("Could not write clipboard image", e);
            return false;
        }
        //  catch (IOException e) {
        //     Ln.e("Could not write clipboard image", e);
